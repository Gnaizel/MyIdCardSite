...
public class TikTokVideoDto {
    ...
    /* Сколько прошло с репоста, в формате треков: 5m, 2h, 3d.
       Пусто у постов, репостнутых до того, как мы начали засекать: TikTok
       времени репоста не отдаёт вовсе, восстановить его неоткуда. */
    private String age;
