...
public class TikTokVideoDto {
    ...
    /* Когда автор выложил само видео. Наружу не уходит: из него считается
       age, когда времени репоста мы не знаем. */
    @JsonIgnore
    private long createdAt;

    /* Сколько прошло, в формате треков: 5m, 2h, 3d. */
    private String age;

    /* Что именно означает age. TikTok не отдаёт, когда пост был репостнут,
       поэтому для новых мы засекаем время сами, а для тех, что лежали
       до начала наблюдения, показываем возраст самого видео — и честно
       подписываем, что это разные вещи. */
